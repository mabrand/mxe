...
define $(PKG)_BUILD
    cd '$(1)' && ./configure \
        ...
        --disable-readline \
        CFLAGS="-Os -DSQLITE_THREADSAFE=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_DQS=0 -DSQLITE_ENABLE_UNLOCK_NOTIFY -DSQLITE_ENABLE_SORTER_REFERENCES -DSQLITE_ENABLE_BYTECODE_VTAB -DSQLITE_ENABLE_PREUPDATE_HOOK"
